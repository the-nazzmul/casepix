        ...
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={global.text}>
              ...
              your package has been shipped. Delivery usually takes 3-5 business
              days.
            </Text>
          ...
          <Section style={paddingY}>
            <Row>
              ...
              >
                Please contact us if your have any questions. (If you reply to
                this email, we will not be able to see it.)
              </Text>
            </Row>
            <Row style={footer.text}>
              &copy; CasePix, Inc. All Rights Reserved.
            </Row>
          </Section>
        </Container>
      </Body>
