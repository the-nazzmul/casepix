...
export default function Home() {
  return (
    <div className="bg-slate-50">
        ...
        <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52 ">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <h1 className="relative w-fit tracking-tight text-balance mt-20 font-bold !leading-tight text-gray-900 text-5xl md:text-5xl lg:text-6xl">
                Protect What You Love,{" "}
                <span className="bg-green-600 px-2 text-white">Showcase</span>{" "}
                What You Live.
              </h1>
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                Capture your favorite memories with your own,{" "}
                <span className="font-semibold">one-of-one</span> phone case.
                CasePix allows you to protect your memories, not just your phone
                case.
              </p>
              ...
              <div className="mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5">
                <div className="flex -space-x-4">
                  ...
                  />
                  <Image
                    className="inline-block h-10 w-10 rounded-full ring-2 ring-slate-200 object-cover"
      ...
      {/* TODO: Need to make this section fully dynamic */}
      {/* First review */}
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="flex gap-4 mt-2">
                ...
                <div className="flex flex-col">
                  <p className="font-semibold">Mike Freeman</p>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p className="text-justify">
                  ...
                  scratch on the corner, looks brand new after about half a
                  year. I dig it!&ldquo;
                </p>
              </div>
              <div className="flex gap-4 mt-2">
